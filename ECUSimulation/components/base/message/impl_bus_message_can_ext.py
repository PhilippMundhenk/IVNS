...
class CANExtendedMessage(AbstractBusMessage):
    ''' 
    ...
    def msg_length_in_bit(self):  
        ...
        try:
            ...
            self._msg_length_in_bit = 60 + len(bit_rep) + self.no_stuffing_bits
            return self._msg_length_in_bit
        except:
            L().log_err(400)
 
 
class CANSegExtendedMessage(AbstractSegmentBusMessage):
    ''' 
    This class is an abstract implementation of a CAN Message with 29
    bit identifier
    '''
    ...
    def msg_length_in_bit(self):  
        ...
        try:
            ...
            self._msg_length_in_bit = 60 + bit_rep + self.no_stuffing_bits
            return self._msg_length_in_bit
