...
def main(argv):
    ...
    paths = {"tesla/CyaSSL/False/", "tesla/Crypto_Lib_HW/False/"}
    ...
    #     for e in range(4, 6):
            ...
            for r in range(0, 21):
                ...
                AuthStart = [i[0] for i in readerList if i[3] == "MonitorTags.CP_SEND_SYNC_MESSAGE"][0]
                AuthEnd = [[i[0], i[1]] for i in readerList if i[3] == "MonitorTags.CP_INIT_TRANSMIT_MESSAGE"]
...
#                 AuthVals = dict()
#                 for f in AuthEnd:
#                     AuthVals[f[1]] = float(f[0]) - float(AuthStart)
# #                 
#                 print(AuthVals)
...
#                         maxAuths[r] = AuthVals[m]
#                     elif (AuthVals[m] > maxAuths[r]):
#                         maxAuths[r] = AuthVals[m]
                for m in AuthEnd:
