...
'''==================================================================================================
    ...
    description:        this module exemplarily shows the functionality of the ECUSimulation     
                        ...
                        by Philipp Mundhenk et al. It also describes how the API of the ECUSimulation
                        should be used.
=================================================================================================='''
...
api.register_ecu_classes(os.path.join(os.path.dirname(__file__), "../ECUSimulation/components/base/gateways"))
...
# optionally use another library on access of the timing variable t_ecu_auth_reg_msg_validate_cert
